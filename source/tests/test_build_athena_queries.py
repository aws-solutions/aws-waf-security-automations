...
def test_build_athena_queries_for_cloudfront_logs():
    ...
    with open('../tests/cloudfront_logs_query.txt', 'r') as file:
...
def test_build_athena_queries_for_alb_logs():
    ...
    with open('../tests/alb_logs_query.txt', 'r') as file:
...
def test_build_athena_queries_for_waf_logs():
    ...
    with open('../tests/waf_logs_query.txt', 'r') as file:
...
def test_add_athena_partitions_build_query_string():
    ...
    with open('../tests/athena_partitions_query.txt', 'r') as file:
